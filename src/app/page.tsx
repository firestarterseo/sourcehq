    ...
    <main className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #EDE9FE 0%, #E0E7FF 100%)' }}>
      <div className="w-full max-w-md">
        <div style={{ background: '#fff', borderRadius: '16px', overflow: 'hidden', border: '0.5px solid #E5E5E3' }}>
          <div style={{ background: 'linear-gradient(135deg, #EDE9FE 0%, #E0E7FF 100%)', padding: '32px', textAlign: 'center' }}>
            <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '28px', fontWeight: '700', color: '#0D1B3E', marginBottom: '6px', letterSpacing: '-0.02em' }}>
              SOURCE <span style={{ color: '#6D28D9' }}>HQ</span>
            </h1>
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '12px', fontWeight: '600', color: '#6D28D9', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              SOURCED not Cited™
            </p>
          </div>
          <div style={{ padding: '28px' }}>
            ...
            <a href="/auth/login" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', width: '100%', padding: '10px 16px', border: '0.5px solid #E5E5E3', borderRadius: '8px', background: '#fff', fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: '500', color: '#0D1B3E', textDecoration: 'none', cursor: 'pointer' }}>
